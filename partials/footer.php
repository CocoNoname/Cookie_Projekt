<footer class="container bg-dark text-white">
    <div class="row">
      ...
      <div class="col-25 text-left">
        <h4>Kontakty</h4>
        <p><i class="fa fa-envelope" aria-hidden="true"><a href="mailto:erik.csicso@gmail.com"> erik.csicso@gmail.com</a></i></p>
        <p><i class="fa fa-phone" aria-hidden="true"><a href="tel:0948838466"> 0948838466</a></i></p>
      </div>
      <div class="col-25">
        <h4>Rýchle odkazy</h4>
        <p><a href="/">Domov</a></p>
